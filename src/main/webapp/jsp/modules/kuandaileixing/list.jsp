                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            <input type="text" id="kdnameSearch" class="form-control form-control-sm"
                                                   placeholder="宽带名称" aria-controls="tableId">
                                        </label>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('kdname')">宽带名称</th>
                                    <th onclick="sort('noticeContent')">套餐描述</th>
                                    <th onclick="sort('money')">宽带价格</th>
                                    <th onclick="sort('speed')">宽带速度</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function search() {
        ...
        if ($('#kdnameSearch').val() != null && $('kdnameSearch').val() != '') {
            searchForm.kdname = $('#kdnameSearch').val();
    ...
    function getDataList() {
        http("kuandaileixing/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
                    kdname: searchForm.kdname,
    }, (res) => {
            if(res.code == 0
            )
            {
    ...
    function setDataRow(item, number) {
        ...
        var kdnameCell = document.createElement('td');
        kdnameCell.innerHTML = item.kdname;
        row.appendChild(kdnameCell);
        ...
        speedCell.innerHTML = item.speed;
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("kuandaileixing/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function getSum(colName) {
        http("kuandaileixing" + colName, "GET", {
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "kuandaileixing");
