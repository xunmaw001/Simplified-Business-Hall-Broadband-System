                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>宽带名称</label>
                                        <input id="kdname" name="kdname" class="form-control"
                                               placeholder="宽带名称">
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>宽带价格</label>
                                    <input id="money" name="money" class="form-control"
                                           onchange="moneyChickValue(this)" placeholder="宽带价格">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>宽带速度</label>
                                    <input id="speed" name="speed" class="form-control"
                                           onchange="speedChickValue(this)"  placeholder="宽带速度">
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "kuandaileixing/info/" + id,
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("kuandaileixing/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("kuandaileixing/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
