                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>宽带名称 Search</label>

                                        <input id="kdname" name="kdname" class="form-control"
                                               v-model="ruleForm.kdname" readonly>
                                    </div>
                                <div>
                                    <label>套餐描述</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="moneyTime" name="moneyTime" class="form-control"
                                               v-model="ruleForm.moneyTime" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>宽带速度</label>

                                        <input id="speed" name="speed" class="form-control"
                                               v-model="ruleForm.speed" readonly>
                                    </div>
