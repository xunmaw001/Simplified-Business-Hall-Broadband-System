                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                ...
                                <button onclick="conzhi()" type="button" class="btn btn-success 充值">充值</button>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>头像</th>
                                    <th onclick="sort('balance')">余额</th>
                                    <th onclick="sort('number')">手机号</th>
                                    <th onclick="sort('family')">住址</th>
                                    <th onclick="sort('identity')">身份证号</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        balanceCell.innerHTML = item.balance;
        ...
        identityCell.innerHTML = item.identity;
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("yonghuxinxi/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "yonghuxinxi");
