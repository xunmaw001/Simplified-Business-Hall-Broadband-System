                            ...
                            <div class="form-row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="balance" name="balance" class="form-control" type="number"
                                            onchange="balanceChickValue(this)" value="0" placeholder="余额"
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yonghuxinxi/info/" + id,
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("yonghuxinxi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("yonghuxinxi/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
